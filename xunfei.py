...
logger = log.logging.getLogger('xunfei')
...
class Ws_Client(object):
    # 初始化
    def __init__(self, APPID, APIKey, APISecret, AudioFile, Format="pcm"):
        self.APPID = APPID
        self.APIKey = APIKey
        self.APISecret = APISecret
        self.AudioFile = AudioFile
        self.Format = Format
        if self.Format == "pcm" or self.Format == "wav":
            self.Format = "raw"
        self.Result = ""
        ...
        self.ws = None
        self.url = 'ws://ws-api.xfyun.cn/v2/iat'
...
if __name__ == "__main__":
    ...
    client = Ws_Client(APPID=conf['xunfei']['appid'], APIKey=conf['xunfei']['apikey'], APISecret=conf['xunfei']['apisecret'],
